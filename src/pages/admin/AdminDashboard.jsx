      ...
      <header className="bg-white border-b border-slate-200 px-6 py-3.5 flex items-center justify-between sticky top-0 z-20 shadow-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-red-50 hover:text-red-600
                       text-slate-600 rounded-xl text-sm font-semibold transition-all"
          >
                      ...
                      <div className="flex flex-col items-end gap-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button onClick={() => handleApprove(m._id)} disabled={!!acting[m._id]}
                            className="flex items-center gap-1.5 px-4 py-2 bg-emerald-50 hover:bg-emerald-100
