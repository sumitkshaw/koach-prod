...
function Listing() {
  ...
  const fallbackMentors = [
    ...
    },
    {
      ...
      location: 'asia',
      language: 'english',
      skillset: ['python', 'nodejs', 'javascript'],
      hourlyCharge: 200
    },
    {
      id: 8,
      ...
      badge: 'Available ASAP',
      badgeType: 'primary',
      serviceCategory: 'product-management',
      industry: 'finance',
      location: 'europe',
      language: 'english',
      skillset: ['project-management', 'javascript'],
      hourlyCharge: 175
    },
    {
      id: 9,
    ...
    },
    {
      ...
      language: 'english',
      skillset: ['javascript', 'nodejs', 'python'],
      hourlyCharge: 195
    }
  ];
