...
export default function BioStep() {
  ...
  const validateForm = () => {
    ...
    if (!formData.domain) newErrors.domain = "Please select your domain";
        ...
        <div className="w-full max-w-xl relative z-10">
          ...
          <div className="flex flex-col items-center justify-center mb-6 sm:mb-8 lg:mb-8">
            <div className="relative mb-4">
              <h1 className="text-2xl sm:text-3xl lg:text-3xl font-bold bg-gradient-to-r from-[#1E4AB8] to-[#4A90E2] bg-clip-text text-transparent text-center leading-tight">
                Your Bio
              </h1>
            ...
            <p className="text-sm sm:text-base text-gray-600 lg:text-[#1E4AB8] text-center mt-4 lg:mt-0 px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-4 lg:gap-4">
            ...
            <div className="flex flex-col sm:col-span-2">
              ...
              <select
                ...
                onChange={handleChange}
                className={`border-2 rounded-xl px-4 py-3.5 bg-white/80 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-[#FFD93B] focus:border-transparent shadow-sm lg:shadow-none transition-all duration-200 appearance-none ${
                  errors.domain ? "border-red-500 bg-red-50/50" : "border-gray-200 lg:border-[#1E4AB8] hover:border-[#4A90E2]"
                }`}
              >
