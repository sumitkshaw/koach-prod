    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full lg:w-1/2 bg-gradient-to-br from-blue-50 via-white to-indigo-50 lg:bg-white flex flex-col justify-center items-center px-4 sm:px-6 py-8 sm:py-12 lg:px-16 relative overflow-hidden">
        ...
        <div className="max-w-2xl w-full flex flex-col items-center justify-center relative z-10">
          ...
          {/* Enhanced Goals Grid for Mobile */}
          <div className="flex flex-col gap-3 sm:gap-4 w-full mb-4 sm:mb-6">
            {goals.map((goal, index) => (
              <button
                key={goal.label}
                onClick={() => handleSelect(goal)}
                className={`group flex items-start sm:items-center gap-3 sm:gap-4 p-4 sm:p-4 border-2 rounded-2xl lg:rounded-lg text-left transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden backdrop-blur-sm ${
            ...
            <div className="w-full mb-4 sm:mb-6">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl lg:rounded-lg p-4 shadow-xl lg:shadow-none border border-gray-200 lg:border-transparent">
                ...
                <input
                  ...
                  placeholder="Enter your specific goal for joining Koach..."
          ...
          <div className="lg:hidden w-full mb-6">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-200">
              ...
              <ul className="text-xs text-gray-600 space-y-1">
                <li>• Helps us match you with the right resources</li>
                <li>• Guides your coaching journey on the platform</li>
                <li>• Enables personalized support and recommendations</li>
              </ul>
            </div>
          </div>
          ...
          <div className="lg:hidden mt-6 text-center">
            <p className="text-xs text-gray-500 px-4">
              Your goals help us create the best possible experience for your coaching journey
            </p>
          </div>
        </div>
      </div>
